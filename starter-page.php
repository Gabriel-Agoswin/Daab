...
<head>
  ...
  <!-- Fonts -->
  <link href="https://fonts.googleapis.com" rel="">
...
<body class="starter-page-page">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li  class="search">
            ...
            <li><a href="#team">Become a member</a></li> 
           
            
            <li><button class="C_Login create btn btn-success"><a href="#Sign-up" class="C_Login rounded" >Sign Up</a></button></li>
            <li><button class="C_Login create btn btn-success"><a href="#Sign-up" class=" rounded">Login</a></button></li>
          </ul>
  ...
  <footer id="footer" class="footer dark-background">
    ...
    <div class="container copyright text-center mt-4">
      ...
      <p> © <span>Copyright</span> <strong class="px-1 sitename">Daab</strong> <span>2024</span></p>
      <div class="credits">
      ...
      <h1 class="sitename d-flex "> <img src="./assets/img/use Brand new logo big.png" width="40" height="40" alt="">Daab</h1> 
